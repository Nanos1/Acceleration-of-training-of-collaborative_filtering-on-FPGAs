...
void write_sim(float* similarity_software, float set_of_U[USOF], float set_of_V[USOF], float set_of_UV[USOF], int common[USOF], int i, int j, int numUsers){
	int ii=i%USOF;
	if(common[ii]>1){
...
void learn_software(float* data, float* similarity_software, int numUsers, int numItems){
	int ii=0;
	float set_of_U[USOF], set_of_V[USOF], set_of_UV[USOF];
	int common[USOF];
