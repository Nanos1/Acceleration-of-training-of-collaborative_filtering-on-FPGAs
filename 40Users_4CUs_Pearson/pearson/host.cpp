...
//	float   *final_data     = (float*)sds_alloc(data_matrix_size_bytes);
	...
	//HARDWARE LEARN FUNCTION------------------------
        ...
        #pragma SDS async(1);
        toplevelHW_learn(data, similarity, setN , U, V, numUsers, numItems, 0, 121);

        #pragma SDS resource(2)
        #pragma SDS async(2);
        toplevelHW_learn(data, similarity, setN , U, V, numUsers, numItems, 121, 282);

        #pragma SDS resource(3)
        #pragma SDS async(3);
        toplevelHW_learn(data, similarity, setN , U, V, numUsers, numItems, 282, 483);

        #pragma SDS resource(4)
        #pragma SDS async(4);
        toplevelHW_learn(data, similarity, setN , U, V, numUsers, numItems, 483, 943);
