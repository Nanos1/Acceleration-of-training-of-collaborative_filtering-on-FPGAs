...
void calculate_sum(float* data, int euclidean_sum[USOF], int set_UV[USOF], int i, int j, int k, int numItems);
void calculate_sim(float* similarity_software, int euclidean_sum[USOF], int set_UV[USOF], int i, int j, int numUsers);
void clear(int set_UV[USOF]);
void clearsum(float euclidean_sum[USOF]);
...
#pragma SDS data mem_attribute (data: CACHEABLE|PHYSICAL_CONTIGUOUS)
#pragma SDS data mem_attribute (similarity: CACHEABLE|PHYSICAL_CONTIGUOUS)
