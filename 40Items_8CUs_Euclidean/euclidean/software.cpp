...
void clearSetUV(int set_UV[USOF]){
...
void calculate_sum(float* data, float euclidean_sum[USOF], int set_UV[USOF], int i, int j, int k, int numItems){
	int ii=i%USOF;
...
void calculate_sim(float* similarity_software, float euclidean_sum[USOF], int set_UV[USOF], int i, int j, int numUsers){
	int ii=i%USOF;
	if(set_UV[ii]>1){ 
