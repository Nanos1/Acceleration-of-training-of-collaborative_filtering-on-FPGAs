...
//	float   *final_data     = (float*)sds_alloc(data_matrix_size_bytes);
	...
	//HARDWARE LEARN FUNCTION------------------------
        ...
        toplevelHW_learn(data, similarity, numUsers, numItems, 0, 41);

        #pragma SDS resource(2)
        #pragma SDS async(2);
        toplevelHW_learn(data, similarity, numUsers, numItems, 41, 82);

        #pragma SDS resource(3)
        #pragma SDS async(3);
        toplevelHW_learn(data, similarity, numUsers, numItems, 82, 123);

        #pragma SDS resource(4)
        #pragma SDS async(4);
        toplevelHW_learn(data, similarity, numUsers, numItems, 123, 204);

        #pragma SDS resource(5)
        #pragma SDS async(5);
        toplevelHW_learn(data, similarity, numUsers, numItems, 204, 285);

        #pragma SDS resource(6)
        #pragma SDS async(6);
        toplevelHW_learn(data, similarity, numUsers, numItems, 285, 406);

        #pragma SDS resource(7)
        #pragma SDS async(7);
        toplevelHW_learn(data, similarity, numUsers, numItems, 406, 567);

        #pragma SDS resource(8)
        #pragma SDS async(8);
        toplevelHW_learn(data, similarity, numUsers, numItems, 567, 943);
