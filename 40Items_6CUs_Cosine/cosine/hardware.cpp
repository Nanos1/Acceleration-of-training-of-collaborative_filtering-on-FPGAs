...
void initsetN(float* data, int* setN , int numItems, int indx, int lmtindx){
	int N0=0;
	for(int i=indx;i<lmtindx;i++){
		N0=0;
...
void toplevelHW_learn(float* data, float* similarity, int* setN , int numUsers, int numItems, int indx, int lmtindx){

	stream_data_fifo _data;
	#pragma HLS stream variable=_data depth=943
	...
	initsetN(data, setN, numItems, indx, lmtindx);
		...
		for(int k=0;k<Item_tiles;k++){
			...
			for(int j=i+1;j<numUsers;j++){
                                if(isfull0==USER_SIZE){
                                        simisfull(similarity, setN, _sim0, i, jjj0, numUsers, k, flg);
					simisfull(similarity, setN, _sim1, i+1, jjj0, numUsers, k, flg);
					simisfull(similarity, setN, _sim2, i+2, jjj0, numUsers, k, flg);
					simisfull(similarity, setN, _sim3, i+3, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim4, i+4, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim5, i+5, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim6, i+6, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim7, i+7, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim8, i+8, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim9, i+9, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim10, i+10, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim11, i+11, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim12, i+12, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim13, i+13, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim14, i+14, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim15, i+15, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim16, i+16, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim17, i+17, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim18, i+18, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim19, i+19, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim20, i+20, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim21, i+21, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim22, i+22, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim23, i+23, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim24, i+24, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim25, i+25, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim26, i+26, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim27, i+27, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim28, i+28, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim29, i+29, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim30, i+30, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim31, i+31, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim32, i+32, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim33, i+33, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim34, i+34, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim35, i+35, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim36, i+36, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim37, i+37, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim38, i+38, jjj0, numUsers, k, flg);
                                        simisfull(similarity, setN, _sim39, i+39, jjj0, numUsers, k, flg);
					isfull0=0;
                                        jjj0+=USER_SIZE;
                                }
...
void simisfull(float* similarity, int* setN, int _sim[USER_SIZE], int i, int jjj, int numUsers, int k, int flg){ 
	...
	int temp_setV;
		...
		if(k==flg){
			temp_setU = setN[i]; // setU
			temp_setV = setN[jjj]; // setV 
			temp_setUV = temp_sim; // setU /\ setV 
			if(temp_setUV>1){
				ttemp_sim = temp_setUV/sqrt(temp_setU*temp_setV);
			}
			else{
				ttemp_sim = 0;
			}
