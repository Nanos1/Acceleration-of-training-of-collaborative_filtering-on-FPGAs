...
//	float   *final_data     = (float*)sds_alloc(data_matrix_size_bytes);
	...
	#pragma SDS async(1);
	toplevelHW_learn(data, similarity, setN, numUsers, numItems, 0, 121);

	#pragma SDS resource(2)
    	#pragma SDS async(2);
        toplevelHW_learn(data, similarity, setN, numUsers, numItems, 121, 322);

        #pragma SDS resource(3)
        #pragma SDS async(3);
        toplevelHW_learn(data, similarity, setN, numUsers, numItems, 322, 523);

        #pragma SDS resource(4)
        #pragma SDS async(4);
        toplevelHW_learn(data, similarity, setN, numUsers, numItems, 523, 804);

        #pragma SDS resource(5)
        #pragma SDS async(5);
        toplevelHW_learn(data, similarity, setN, numUsers, numItems, 804, 1125);

        #pragma SDS resource(6)
        #pragma SDS async(6);
        toplevelHW_learn(data, similarity, setN, numUsers, numItems, 1125, numUsers);
