...
//	float   *final_data     = (float*)sds_alloc(data_matrix_size_bytes);
	...
	#pragma SDS async(1);
	toplevelHW_learn(data, similarity, numUsers, numItems, 0, 81);

	#pragma SDS resource(2)
    	#pragma SDS async(2);
	toplevelHW_learn(data, similarity, numUsers, numItems, 81, 162);

	#pragma SDS resource(3)
    	#pragma SDS async(3);
        toplevelHW_learn(data, similarity, numUsers, numItems, 162, 207);

    	#pragma SDS resource(4)
    	#pragma SDS async(4);
        toplevelHW_learn(data, similarity, numUsers, numItems, 207, 288);

        #pragma SDS resource(5)
        #pragma SDS async(5);
        toplevelHW_learn(data, similarity, numUsers, numItems, 288, 369);

        #pragma SDS resource(6)
        #pragma SDS async(6);
        toplevelHW_learn(data, similarity, numUsers, numItems, 369, 450);

        #pragma SDS resource(7)
        #pragma SDS async(7);
        toplevelHW_learn(data, similarity, numUsers, numItems, 450, 531);

        #pragma SDS resource(8)
        #pragma SDS async(8);
        toplevelHW_learn(data, similarity, numUsers, numItems, 531, 612);

        #pragma SDS resource(9)
        #pragma SDS async(9);
        toplevelHW_learn(data, similarity, numUsers, numItems, 612, 693);

        #pragma SDS resource(10)
        #pragma SDS async(10);
        toplevelHW_learn(data, similarity, numUsers, numItems, 693, 774);

        #pragma SDS resource(11)
        #pragma SDS async(11);
        toplevelHW_learn(data, similarity, numUsers, numItems, 774, 855);

        #pragma SDS resource(12)
        #pragma SDS async(12);
        toplevelHW_learn(data, similarity, numUsers, numItems, 855, 943);
