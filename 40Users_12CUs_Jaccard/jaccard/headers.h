...
void calc_set(float* data, float set_of_U[40], float set_of_UV[40], int i, int j, int k, int numItems);
void clearSetUV(float set_of_U[40],float set_of_UV[40], float &set_of_V);
void calc_sim(float* similarity_software, float set_of_U[40], float set_of_UV[40], float set_of_V, int i, int j, int numUsers);
